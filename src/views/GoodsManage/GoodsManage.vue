<template>
    <div class="page">
        ...
        <!-- <el-table :data="goodsList" border style="width: 100%">
            ...
            <el-table-column prop="shareUrl" label="分享图" width="180">
            </el-table-column>
            <el-table-column prop="shareUrl" label="详情" width="180">
            </el-table-column>
            <el-table-column prop="counterPrice" label="专柜价格" width="180">
            </el-table-column>
            <el-table-column prop="retailPrice" label="分享图" width="180">
            </el-table-column>
            <el-table-column prop="retailPrice" label="是否新品" width="180">
            </el-table-column>
            <el-table-column prop="retailPrice" label="是否热品" width="180">
            </el-table-column>
            <el-table-column prop="retailPrice" label="是否在售" width="180">
            </el-table-column>
            <el-table-column prop="retailPrice" label="操作" width="180">
            </el-table-column>
        </el-table> -->
        <el-table :data="goodsList" border style="{width: 100%}">
